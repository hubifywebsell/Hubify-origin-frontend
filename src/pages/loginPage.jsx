    ...
    onSuccess: (response) => {
      axios
        .post(
          ...
          { withCredentials: true } // ✅ Added for CORS compatibility
        )
        .then((res) => {
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 w-full">
        ...
        <div className="hidden lg:flex flex-col justify-between p-10">
          <div className="flex items-center gap-4">
            <img src="/Hubify.png" alt="Alipres" className="h-10 w-auto" />
          ...
          <div className="flex-1 flex items-center">
            <div className="max-w-xl space-y-6">
              ...
              <p className="text-primary/90 text-lg">
                ...
                your Gaming Race. The best place to start your journey.
              </p>
        ...
        <div className="flex items-center justify-center p-6 sm:p-10">
          <div className="w-full max-w-md">
            <div className="rounded-3xl backdrop-blur-xl bg-white/10 border border-white/20 shadow-2xl p-8 sm:p-10">
              ...
              <div className="mt-8 text-center text-sm text-primary/90">
                New to Alipres?{" "}
                <Link
                  to="/register"
                  className="text-accent hover:underline underline-offset-4"
